#################################################################################
#
# Created by Genus(TM) Synthesis Solution 22.12-s082_1 on Tue Apr 07 16:32:29 +07 2026
#
#################################################################################

## library_sets
create_library_set -name ls_of_ld_slow \
    -timing { /home/NAMDH66/practice/libraries/lib/max/slow.lib \
              /home/NAMDH66/practice/libraries/lib/max/pdkIO.lib }
create_library_set -name ls_of_ld_fast \
    -timing { /home/NAMDH66/practice/libraries/lib/min/fast.lib \
              /home/NAMDH66/practice/libraries/lib/min/pdkIO.lib }

## rc_corner
create_rc_corner -name default_emulate_rc_corner \
    -T 125.0 \
    -qx_tech_file /home/NAMDH66/practice/libraries/tech/qrc/qx/gpdk045.tch \
    -preRoute_res 1.0 \
    -preRoute_cap 1.0 \
    -preRoute_clkres 0.0 \
    -preRoute_clkcap 0.0 \
